(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["quillLabel"] = factory(require("quill"));
	else
		root["quillLabel"] = factory(root["Quill"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__0__) {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	function hotDisposeChunk(chunkId) {
/******/ 		delete installedChunks[chunkId];
/******/ 	}
/******/ 	var parentHotUpdateCallback = window["webpackHotUpdatequillLabel"];
/******/ 	window["webpackHotUpdatequillLabel"] = // eslint-disable-next-line no-unused-vars
...
var eventemitter3 = __webpack_require__(1);
...
// CONCATENATED MODULE: ./src/quill-label-blot.js
...
/* harmony default export */ var quill_label_blot = (LabelBlot);
// CONCATENATED MODULE: ./src/quill-label.js
...
class quill_label_Label extends Module {
  static register() {
    external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.register(quill_label_blot, true);
  }
  ...
  constructor(quill, options) {
    ...
    [].slice.call(options.data || []).forEach(opt => selectHtml += "<option value=\"".concat(opt.value, "\">").concat(opt.label, "</option>"));
    selectHtml += '</select>';
  ...
  openLabelSelect() {
    ...
    this.root.style.top = "".concat(10 + atSignBounds.top + atSignBounds.height, "px");

    if (paletteMaxPos > this.quill.container.offsetWidth) {
      this.root.style.left = "".concat(atSignBounds.left - 250, "px");
    } else {
      this.root.style.left = "".concat(atSignBounds.left, "px");
    }
...
quill_label_Label.DEFAULTS = {
  buttonIcon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18"><path fill="none" d="M0 0h24v24H0z"/><path fill="#444" stroke-width="1" d="M4 2h16a1 1 0 0 1 1 1v19.276a.5.5 0 0 1-.704.457L12 19.03l-8.296 3.702A.5.5 0 0 1 3 22.276V3a1 1 0 0 1 1-1zm15 17.965V4H5v15.965l7-3.124 7 3.124zM12 13.5l-2.939 1.545.561-3.272-2.377-2.318 3.286-.478L12 6l1.47 2.977 3.285.478-2.377 2.318.56 3.272L12 13.5z"/></svg>'
};
/* harmony default export */ var quill_label = __webpack_exports__["default"] = (quill_label_Label);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var src_quill_label_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var src_assets_quill_label_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var src_assets_quill_label_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(src_assets_quill_label_scss__WEBPACK_IMPORTED_MODULE_1__);
 // import better-table styles file


Quill.register({
  'modules/label': src_quill_label_js__WEBPACK_IMPORTED_MODULE_0__["default"]
}, true);
